...
class VillageDetailScreen extends StatefulWidget {
  VillageDetailScreen({Key? key}) : super(key: key);
    ...
    return Padding(
      ...
      child: Stack(
        children: [
            ...
            child: IntrinsicHeight(
              child: Row(
                ...
                children: [
                  ...
                  Container(decoration: BoxDecoration(border: Border(bottom: BorderSide(color: grey.withOpacity(0.2)), top: BorderSide(color: grey.withOpacity(0.2)), left: BorderSide(color: grey.withOpacity(0.2)), right: BorderSide(color: grey.withOpacity(0.2)))), child: Image.asset(hoccoImage)),
                  const SizedBox(
                    width: 10,
                  ),
                  VerticalDivider(
          ...
          const Positioned(top: 10, right: 20, child: Icon(Icons.more_vert_rounded))
        ],
      ),
    );
  }
                                  ...
                                  child: Stack(
                                    children: [
                                      Container(
                                          height: 30,
                                          width: 30,
                                          decoration: BoxDecoration(color: white, borderRadius: BorderRadius.circular(50)),
                                          child: Padding(
