...
import 'package:vande_mission/screen/afterlogin/controller/add_book_controller.dart';
...
class AddBookScreen extends StatelessWidget {
 AddBookScreen({Key? key}) : super(key: key);
  ...
  final AddBookController createBookController = Get.put(AddBookController());
