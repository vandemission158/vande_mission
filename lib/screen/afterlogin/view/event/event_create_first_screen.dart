...
import 'package:vande_mission/screen/afterlogin/controller/event/event_controller.dart';
import 'package:vande_mission/screen/afterlogin/view/event/event_create_second_screen.dart';
...
class EventCreateFirstScreen extends StatelessWidget {
  EventCreateFirstScreen({Key? key}) : super(key: key);
                                ...
                                children: [
                                  Expanded(
                                    child: GestureDetector(
                                      ...
                                      height: 55,
                                      decoration: const BoxDecoration(color: orange, borderRadius: BorderRadius.only(topLeft: Radius.circular(15), bottomLeft: Radius.circular(15))),
                                      child: const Center(
                                          child: TextLabel(
                                        title: "Time",
                                        fontSize: 16,
                                  ...
                                  Expanded(
                                    child: GestureDetector(
                                      ...
                                      width: Constants.width(context),
                                      height: 55,
                                      decoration: const BoxDecoration(color: dropdownColor, borderRadius: BorderRadius.only(topRight: Radius.circular(15), bottomRight: Radius.circular(15))),
                                      child: const Center(
                                          child: TextLabel(
                                        title: "Full Day",
                                        fontSize: 16,
                              ...
                              child: Padding(
                                ...
                                child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintStyle: GoogleFonts.poppins(color: black.withOpacity(0.4), fontSize: 16, fontWeight: FontWeight.w400),
                                    )),
                              ),
                            ),
                          ),
