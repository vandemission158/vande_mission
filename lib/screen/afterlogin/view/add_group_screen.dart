                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        CustomDropDown(
                            ...
                            onTap: () =>
                                controller.groupTypeBottomSheet(context),
                            title: "Select Cast"),
                        Padding(
                          ...
                          child: CustomButton(
                              ...
                              onTap: () => controller.addGroupAPICall(
                                  ...
                                  registerFamilyController.subDistrictID
                                      .toInt(),
                                  registerFamilyController.societyID.toInt(),
                                  controller.groupNameController.value.text
                                      .toString(),
                                  controller.aboutGroupController.value.text
                                      .toString(),
                                  controller.groupTypeController.value.text
                                      .toString())
