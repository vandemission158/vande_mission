...
//
//     final adsUpdateModel = adsUpdateModelFromJson(jsonString);

import 'dart:convert';

AdsUpdateModel adsUpdateModelFromJson(String? str) => AdsUpdateModel.fromJson(json.decode(str!));

String? adsUpdateModelToJson(AdsUpdateModel data) => json.encode(data.toJson());

class AdsUpdateModel {
  AdsUpdateModel({
    this.id,
    this.name,
    this.adMediaType,
  ...
  factory AdsUpdateModel.fromJson(Map<String, dynamic> json) => AdsUpdateModel(
        id: json["id"],
        name: json["name"],
