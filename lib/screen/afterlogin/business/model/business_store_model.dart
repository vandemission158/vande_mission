...
BusinessStoreModel businessStoreModelFromJson(String? str) => BusinessStoreModel.fromJson(json.decode(str!));

String? businessStoreModelToJson(BusinessStoreModel data) => json.encode(data.toJson());
...
class BusinessStoreModel {
  ...
  factory BusinessStoreModel.fromJson(Map<String, dynamic> json) => BusinessStoreModel(
        id: json["id"],
        type: json["type"],
