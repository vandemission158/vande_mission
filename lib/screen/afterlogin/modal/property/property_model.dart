...
//
//     final propertyModal = propertyModalFromJson(jsonString);

import 'dart:convert';

PropertyModel propertyModalFromJson(String str) =>
    PropertyModel.fromJson(json.decode(str));

String propertyModalToJson(PropertyModel data) => json.encode(data.toJson());
