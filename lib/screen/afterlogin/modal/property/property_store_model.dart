...
PropertyStoreModel propertyStoreModelFromJson(String? str) =>
    PropertyStoreModel.fromJson(json.decode(str!));

String? propertyStoreModelToJson(PropertyStoreModel data) =>
...
class PropertyStoreModel {
  ...
  factory PropertyStoreModel.fromJson(Map<String, dynamic> json) =>
      PropertyStoreModel(
        id: json["id"],
        type: json["type"],
        name: json["name"],
