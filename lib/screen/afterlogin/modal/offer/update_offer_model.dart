...
//
//     final updateOfferModel = updateOfferModelFromJson(jsonString);

import 'dart:convert';

UpdateOfferModel updateOfferModelFromJson(String str) =>
    UpdateOfferModel.fromJson(json.decode(str));

String updateOfferModelToJson(UpdateOfferModel data) =>
