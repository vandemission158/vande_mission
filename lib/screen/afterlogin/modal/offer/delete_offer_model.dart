...
//
//     final deleteOfferModel = deleteOfferModelFromJson(jsonString);

import 'dart:convert';

DeleteOfferModel deleteOfferModelFromJson(String str) =>
    DeleteOfferModel.fromJson(json.decode(str));

String deleteOfferModelToJson(DeleteOfferModel data) =>
    json.encode(data.toJson());

class DeleteOfferModel {
  DeleteOfferModel({
    this.id,
    this.division,
    this.name,
  ...
  factory DeleteOfferModel.fromJson(Map<String, dynamic> json) =>
      DeleteOfferModel(
        ...
        isTotalOfferMember: json["isTotalOfferMember"],
        ...
        offermember: List<dynamic>.from(json["offermember"].map((x) => x)),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "photo_url": photoUrl,
        "isTotalOfferMember": isTotalOfferMember,
        ...
        "owner": owner!.toJson(),
        "offermember": List<dynamic>.from(offermember!.map((x) => x)),
      };
}
