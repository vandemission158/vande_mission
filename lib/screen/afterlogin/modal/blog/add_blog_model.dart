...
//
//     final addBlogModel = addBlogModelFromJson(jsonString);

import 'dart:convert';

AddBlogModel addBlogModelFromJson(String str) =>
    AddBlogModel.fromJson(json.decode(str));

String addBlogModelToJson(AddBlogModel data) => json.encode(data.toJson());
...
class AddBlogModel {
  ...
  factory AddBlogModel.fromJson(Map<String, dynamic> json) => AddBlogModel(
        ...
        isTotalBlogMember: json["isTotalBlogMember"],
        ...
        blogmember: List<dynamic>.from(json["blogmember"].map((x) => x)),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "photo_url": photoUrl,
        "isTotalBlogMember": isTotalBlogMember,
        ...
        "owner": owner!.toJson(),
        "blogmember": List<dynamic>.from(blogmember!.map((x) => x)),
      };
}
