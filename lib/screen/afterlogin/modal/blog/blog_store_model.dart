...
//
//     final blogStoreModel = blogStoreModelFromJson(jsonString);
...
BlogStoreModel blogStoreModelFromJson(String? str) => BlogStoreModel.fromJson(json.decode(str!));

String? blogStoreModelToJson(BlogStoreModel data) => json.encode(data.toJson());

class BlogStoreModel {
  BlogStoreModel({
    this.id,
    this.title,
    this.keywords,
  ...
  factory BlogStoreModel.fromJson(Map<String, dynamic> json) => BlogStoreModel(
        id: json["id"],
        title: json["title"],
