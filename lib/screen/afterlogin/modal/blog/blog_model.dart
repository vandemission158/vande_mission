...
//
//     final blogModal = blogModalFromJson(jsonString);

import 'dart:convert';

BlogModel blogModalFromJson(String str) => BlogModel.fromJson(json.decode(str));

String blogModalToJson(BlogModel data) => json.encode(data.toJson());
