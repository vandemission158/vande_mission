...
UpdateBlogModel updateBlogModelFromJson(String str) =>
    UpdateBlogModel.fromJson(json.decode(str));

String updateBlogModelToJson(UpdateBlogModel data) =>
...
class UpdateBlogModel {
  ...
  factory UpdateBlogModel.fromJson(Map<String, dynamic> json) =>
      UpdateBlogModel(
        id: json["id"],
