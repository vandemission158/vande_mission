...
//
//     final updateBroadcastModel = updateBroadcastModelFromJson(jsonString);

import 'dart:convert';

UpdateBroadcastModel updateBroadcastModelFromJson(String str) =>
    UpdateBroadcastModel.fromJson(json.decode(str));

String updateBroadcastModelToJson(UpdateBroadcastModel data) =>
    json.encode(data.toJson());

class UpdateBroadcastModel {
  ...
  factory UpdateBroadcastModel.fromJson(Map<String, dynamic> json) =>
      UpdateBroadcastModel(
        id: json["id"],
