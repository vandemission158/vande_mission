...
//
//     final addBroadcastModel = addBroadcastModelFromJson(jsonString);

import 'dart:convert';

AddBroadcastModel addBroadcastModelFromJson(String str) =>
    AddBroadcastModel.fromJson(json.decode(str));

String addBroadcastModelToJson(AddBroadcastModel data) =>
    json.encode(data.toJson());

class AddBroadcastModel {
  AddBroadcastModel({
    this.id,
    this.division,
    this.name,
  ...
  factory AddBroadcastModel.fromJson(Map<String, dynamic> json) =>
      AddBroadcastModel(
        id: json["id"],
