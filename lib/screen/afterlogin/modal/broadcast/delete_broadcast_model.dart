...
//
//     final deleteBroadcastModel = deleteBroadcastModelFromJson(jsonString);

import 'dart:convert';

DeleteBroadcastModel deleteBroadcastModelFromJson(String str) =>
    DeleteBroadcastModel.fromJson(json.decode(str));

String deleteBroadcastModelToJson(DeleteBroadcastModel data) =>
    json.encode(data.toJson());

class DeleteBroadcastModel {
  ...
  factory DeleteBroadcastModel.fromJson(Map<String, dynamic> json) =>
      DeleteBroadcastModel(
        id: json["id"],
