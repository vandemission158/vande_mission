...
//
//     final bookModal = bookModalFromJson(jsonString);

import 'dart:convert';

BookModel bookModalFromJson(String str) => BookModel.fromJson(json.decode(str));

String bookModalToJson(BookModel data) => json.encode(data.toJson());
