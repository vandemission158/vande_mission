...
//
//     final deleteBookModel = deleteBookModelFromJson(jsonString);

import 'dart:convert';

DeleteBookModel deleteBookModelFromJson(String str) =>
    DeleteBookModel.fromJson(json.decode(str));

String deleteBookModelToJson(DeleteBookModel data) =>
