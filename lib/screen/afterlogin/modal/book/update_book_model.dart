...
//
//     final updateBookModel = updateBookModelFromJson(jsonString);

import 'dart:convert';

UpdateBookModel updateBookModelFromJson(String str) =>
    UpdateBookModel.fromJson(json.decode(str));

String updateBookModelToJson(UpdateBookModel data) =>
...
class UpdateBookModel {
  ...
  factory UpdateBookModel.fromJson(Map<String, dynamic> json) =>
      UpdateBookModel(
        ...
        isTotalBookMember: json["isTotalBookMember"],
        ...
        bookmember: List<dynamic>.from(json["bookmember"].map((x) => x)),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "photo_url": photoUrl,
        "isTotalBookMember": isTotalBookMember,
        ...
        "owner": owner!.toJson(),
        "bookmember": List<dynamic>.from(bookmember!.map((x) => x)),
      };
}
