...
//
//     final updateEventModel = updateEventModelFromJson(jsonString);

import 'dart:convert';

UpdateEventModel updateEventModelFromJson(String str) =>
    UpdateEventModel.fromJson(json.decode(str));

String updateEventModelToJson(UpdateEventModel data) =>
...
class UpdateEventModel {
  ...
  factory UpdateEventModel.fromJson(Map<String, dynamic> json) =>
      UpdateEventModel(
        id: json["id"],
