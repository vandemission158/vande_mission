...
//
//     final deleteEventModel = deleteEventModelFromJson(jsonString);

import 'dart:convert';

DeleteEventModel deleteEventModelFromJson(String str) =>
    DeleteEventModel.fromJson(json.decode(str));

String deleteEventModelToJson(DeleteEventModel data) =>
