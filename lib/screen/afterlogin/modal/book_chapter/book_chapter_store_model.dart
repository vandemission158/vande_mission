...
BookChapterStoreModel bookChapterStoreModelFromJson(String? str) => BookChapterStoreModel.fromJson(json.decode(str!));

String? bookChapterStoreModelToJson(BookChapterStoreModel data) => json.encode(data.toJson());
...
class BookChapterStoreModel {
  ...
  factory BookChapterStoreModel.fromJson(Map<String, dynamic> json) => BookChapterStoreModel(
        id: json["id"],
