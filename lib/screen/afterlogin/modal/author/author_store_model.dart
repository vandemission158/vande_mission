...
AuthorStoreModel authorStoreModelFromJson(String? str) =>
    AuthorStoreModel.fromJson(json.decode(str!));

String? authorStoreModelToJson(AuthorStoreModel data) =>
...
class AuthorStoreModel {
  ...
  factory AuthorStoreModel.fromJson(Map<String, dynamic> json) =>
      AuthorStoreModel(
        id: json["id"],
        name: json["name"],
        photo: json["photo"],
