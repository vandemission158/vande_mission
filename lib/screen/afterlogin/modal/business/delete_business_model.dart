...
//
//     final deleteBusinessModel = deleteBusinessModelFromJson(jsonString);

import 'dart:convert';

DeleteBusinessModel deleteBusinessModelFromJson(String str) =>
    DeleteBusinessModel.fromJson(json.decode(str));

String deleteBusinessModelToJson(DeleteBusinessModel data) =>
