...
//
//     final addGroupModal = addGroupModalFromJson(jsonString);

import 'dart:convert';

AddGroupModal addGroupModalFromJson(String str) => AddGroupModal.fromJson(json.decode(str));

String addGroupModalToJson(AddGroupModal data) => json.encode(data.toJson());
...
class AddGroupModal {
    ...
    factory AddGroupModal.fromJson(Map<String, dynamic> json) => AddGroupModal(
        id: json["id"],
