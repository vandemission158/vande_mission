...
//
//     final deleteGroupModel = deleteGroupModelFromJson(jsonString);

import 'dart:convert';

DeleteGroupModel deleteGroupModelFromJson(String str) =>
    DeleteGroupModel.fromJson(json.decode(str));

String deleteGroupModelToJson(DeleteGroupModel data) =>
