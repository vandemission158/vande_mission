...
//
//     final groupUpdateModel = groupUpdateModelFromJson(jsonString);
...
GroupUpdateModel groupUpdateModelFromJson(String? str) => GroupUpdateModel.fromJson(json.decode(str!));

String? groupUpdateModelToJson(GroupUpdateModel data) => json.encode(data.toJson());
...
class GroupUpdateModel {
  ...
  factory GroupUpdateModel.fromJson(Map<String, dynamic> json) => GroupUpdateModel(
        id: json["id"],
