...
//
//     final updateAdsModel = updateAdsModelFromJson(jsonString);

import 'dart:convert';

UpdateAdsModel updateAdsModelFromJson(String str) =>
    UpdateAdsModel.fromJson(json.decode(str));

String updateAdsModelToJson(UpdateAdsModel data) => json.encode(data.toJson());

class UpdateAdsModel {
  UpdateAdsModel({
    this.id,
    this.division,
    this.name,
  ...
  factory UpdateAdsModel.fromJson(Map<String, dynamic> json) => UpdateAdsModel(
        id: json["id"],
