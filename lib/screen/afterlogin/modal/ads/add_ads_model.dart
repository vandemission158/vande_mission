...
//
//     final addAdsModel = addAdsModelFromJson(jsonString);

import 'dart:convert';

AddAdsModel addAdsModelFromJson(String str) =>
    AddAdsModel.fromJson(json.decode(str));

String addAdsModelToJson(AddAdsModel data) => json.encode(data.toJson());
...
class AddAdsModel {
  ...
  factory AddAdsModel.fromJson(Map<String, dynamic> json) => AddAdsModel(
        id: json["id"],
