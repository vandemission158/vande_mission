...
//
//     final deleteAdsModel = deleteAdsModelFromJson(jsonString);

import 'dart:convert';

DeleteAdsModel deleteAdsModelFromJson(String str) =>
    DeleteAdsModel.fromJson(json.decode(str));

String deleteAdsModelToJson(DeleteAdsModel data) => json.encode(data.toJson());

class DeleteAdsModel {
  DeleteAdsModel({
    this.id,
    this.division,
    this.name,
  ...
  factory DeleteAdsModel.fromJson(Map<String, dynamic> json) => DeleteAdsModel(
        id: json["id"],
