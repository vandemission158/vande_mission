...
class PostDetailScreen extends StatelessWidget {
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        DetectableText(
                          text: " https://pub.dev/packages/detectable_text_field Hello guys, Lorem Ipsum is simply dummy text of the printing and typesetting industry.Lorem Ipsum is simply dummy text of the printing and typesetting industry.#trending #hashtagsdemo #tags",
                          detectionRegExp: RegExp(
                            "(?!\\n)(?:^|\\s)([]([$detectionContentLetters]+))|$urlRegexContent$hashTagRegExp",
                            multiLine: false,
                          ),
                          detectedStyle: GoogleFonts.poppins(color: orange, fontStyle: FontStyle.normal, fontWeight: FontWeight.bold, fontSize: 13),
                          basicStyle: GoogleFonts.poppins(color: missonColor, fontStyle: FontStyle.normal, fontWeight: FontWeight.w400, fontSize: 13),
        ...
        children: [
          SizedBox(
            ...
            child: GestureDetector(
              onTap: () {},
              child: ClipRRect(borderRadius: BorderRadius.circular(15.0), child: Image.asset(controller.commentList[index]["image"].toString())
                  // NetworkImageWidget(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          TextLabel(
                            title: controller.commentList[index]["name"].toString(),
                            fontSize: 14,
                            color: black,
                            fontWeight: FontWeight.w600,
                          ),
                          TextLabel(
                            title: controller.commentList[index]["time"].toString(),
                            fontSize: 11,
                            fontWeight: FontWeight.w400,
                  ...
                  DetectableText(
                    ...
                    detectedStyle: GoogleFonts.poppins(color: blue, fontStyle: FontStyle.normal, fontWeight: FontWeight.bold, fontSize: 13),
                    basicStyle: GoogleFonts.poppins(color: grey, fontStyle: FontStyle.normal, fontWeight: FontWeight.w400, fontSize: 13),
                    onTap: (tappedText) async {},
                  ),
                  const SizedBox(
                    height: 10,
  ...
  Widget feedDetailBottom(
    ...
    return Container(
      decoration: BoxDecoration(
        color: white,
        boxShadow: [BoxShadow(blurRadius: 10, color: Colors.black.withOpacity(0.10), spreadRadius: 1)],
      ),
      child: Column(
        children: [
          Padding(
              ...
              children: [
                ...
                GestureDetector(
                  child: Container(
                    width: 50,
                    height: 50,
                    decoration: BoxDecoration(boxShadow: [BoxShadow(blurRadius: 10, color: Colors.black.withOpacity(0.10), spreadRadius: 1)], color: white, borderRadius: BorderRadius.circular(25)),
                    child: const Center(
                      child: Icon(
                        Icons.send_outlined,
                        size: 20,
