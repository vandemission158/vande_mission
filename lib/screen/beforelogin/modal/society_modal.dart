...
//
//     final societyModal = societyModalFromJson(jsonString);

import 'dart:convert';

SocietyModal societyModalFromJson(String str) => SocietyModal.fromJson(json.decode(str));

String societyModalToJson(SocietyModal data) => json.encode(data.toJson());
...
class SocietyModal {
    ...
    factory SocietyModal.fromJson(Map<String, dynamic> json) => SocietyModal(
